...
from pyTwistyScrambler import scrambler333, scrambler444, scrambler222, scrambler555, scrambler666, scrambler777, scrambler888, scrambler999, scrambler101010, scrambler111111, scrambler121212, scrambler131313, scrambler141414, scrambler151515, bigCubesScrambler, pyraminxScrambler, megaminxScrambler, squareOneScrambler, skewbScrambler, clockScrambler # type: ignore[import]
#from pyTwistyScrambler import scrambler333, scrambler444, scrambler222, scrambler555, scrambler666, scrambler777, bigCubesScrambler, pyraminxScrambler, megaminxScrambler, squareOneScrambler, skewbScrambler, clockScrambler # type: ignore[import]
...
help_lines = [
    ...
    ['8x8 WCA Scramble', '8x8'],
    ['9x9 WCA Scramble', '9x9'],
    ['10x10 WCA Scramble', '10x10'],
    ['11x11 WCA Scramble', '11x11'],
    ['12x12 WCA Scramble', '12x12'],
    ['13x13 WCA Scramble', '13x13'],
    ['14x14 WCA Scramble', '14x14'],
    ['15x15 WCA Scramble', '15x15'],
...
scrambles = OrderedDict([
    ...
    ('8x8', bigCubesScrambler.get_8x8x8_scramble),
    ('9x9', bigCubesScrambler.get_9x9x9_scramble),
    ('10x10', bigCubesScrambler.get_10x10x10_scramble),
    ('11x11', bigCubesScrambler.get_11x11x11_scramble),
    ('12x12', bigCubesScrambler.get_12x12x12_scramble),
    ('13x13', bigCubesScrambler.get_13x13x13_scramble),
    ('14x14', bigCubesScrambler.get_14x14x14_scramble),
    ('15x15', bigCubesScrambler.get_15x15x15_scramble),
